...
ROT_GOAL_TOL = 1.5 #.3  # rad, tolerance to consider a goal complete
TRANS_VEL_OPTS = [0, 0.025, 0.1, -0.025] # [0, 0.025, 0.13, 0.26, -0.05]  # m/s, max of real robot is .26
...
PATH_NAME = 'myhal_path_backwards.npy'  # saved path from l2_planning.py, should be in the same directory as this file
...
class PathFollower():
    def __init__(self):
        ...
        # self.path_tuples = np.load(os.path.join(cur_dir, PATH_NAME))[:, ::-1].T
